...
class LoginPage(BasePage):
    def __init__(self, page):
        super().__init__(page)
        # Update these selectors to match the actual Customer Portal HTML
        self.email_input = "input[name='email']"
        self.password_input = "input[name='password']"
        self.login_button = "button[type='submit']"
        self.error_message_selector = ".error-message"
        self.forgot_password_link = "a[href*='forgot']"
    ...
    def is_logged_in(self) -> bool:
        return self.page.url.__contains__("/dashboard") or self.page.url.__contains__("/home")
